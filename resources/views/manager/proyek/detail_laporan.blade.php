                    ...
                    <div class="card">
                        <div class="d-flex justify-content-between card-header bg-dark text-white">
                            ...
                            <button type="button" class="badge bg-primary ml-auto" data-toggle="modal"
                                data-target=".bd-modal-edit-laporan-modal-lg">
                            ...
                            <x-modal_edit_laporan :laporan="$laporan" />
                        </div>
                        <div class="card-body">
                            ...
                            @foreach ($laporan->insiden as $insiden)
                            ...
                            @endforeach
                            @foreach ($laporan->survei as $survei)
                                <h5 class="card-header bg-dark text-white">SURVEI</h5>
                                <div class="card-body">
                                    <div class="card text-center">
                                        <div class="card-header">
                                    ...
                                    <div class="d-flex justify-content-end mt-3">
                                        <div class="card text-center">
                                            <div class="card-body">
                                                <h5 class="card-title">Pengawas : {{ $laporan->proyek->pengawas }}</h5>
                                            </div>
                                            <div class="card-footer text-muted">
                                                {{ $laporan->created_at }}
                                            </div>
